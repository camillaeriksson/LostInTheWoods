/**
 * Objects in array with different game states for the story
 * @typedef {{ message: String, question: String, firstChoice: String, secondChoice: String, index: GameStateIndexAlternatives }} GameState
 */

 /**
  * Object inside the game state objects for the game state index alternatives
  * @typedef {{first: Number, second: Number}} GameStateIndexAlternatives
  */
